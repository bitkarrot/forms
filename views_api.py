...
@forms_ext.get("/api/v1/invoices", status_code=HTTPStatus.OK)
...
@forms_ext.get("/api/v1/invoice/{invoice_id}", status_code=HTTPStatus.OK)
...
@forms_ext.post("/api/v1/invoice", status_code=HTTPStatus.CREATED)
...
@forms_ext.delete("/api/v1/invoice/{invoice_id}", status_code=HTTPStatus.OK)
...
@forms_ext.post("/api/v1/invoice/{invoice_id}", status_code=HTTPStatus.OK)
...
@forms_ext.delete("/api/v1", status_code=HTTPStatus.OK, dependencies=[Depends(check_admin)])
async def api_stop():
